...
document.getElementById('temprature').innerText= Math.floor(data.main.tem - 273)+ '°C';
...
temp.innerText= Math.floor(forecast.list[i].main.tem_max - 273)+ '°C'+ ' / '; + Math.floor(forecast.list[i].tem_min - 273)+ '°C';
